	...
	<div class="contentsection contemplate clear">
		<div class="maincontent clear">
			<div class="about">
				...
				<p>
				Given the current circumstances due to COVID-19, all the beloved members of our TCS family are being advised and requested to follow the guidelines of the health experts properly to fight against this pandemic. Please stay home, stay safe.
				</p>
			</div>
		</div>
