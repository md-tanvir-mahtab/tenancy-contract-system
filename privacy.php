...
<body>
	...
	<div class="navsection template clear">
		<div class="leftsection">
			...
			<li><a id="active" href="privacy.php">Privacy</a></li>
			</ul>
		</div>
	...
	<div class="contentsection contemplate clear">
		<div class="maincontent clear">
			<div class="about">
				...
				<p>
				Your privacy is our highest priority. All your confidential information are kept protected in our highly secured data center. We by no means share your information to third parties.
				</p>
				<p>
				At present we are not using any cookies, but we are interested to start this service very soon to give you even more better experience.
				</p>
			</div>
		</div>
